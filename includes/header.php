...
<nav class="navbar navbar-expand bg-dark fixed-top" style="height: 100px;">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav ms-auto d-flex flex-row">
            ...
            <li class="nav-item">
                <a class="nav-link text-white px-3" href="/SAVELIFEnew/donors/search.php">البحث عن متبرعين</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white px-3" href="/SAVELIFEnew/patients/search_patients.php">البحث عن مرضى</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white px-3" href="/SAVELIFEnew/centers/map.php">مراكز التبرع</a>
            </li>
            <?php if (isset($_SESSION['donor_id']) || isset($_SESSION['patient_id'])): ?>
            <li class="nav-item">
                <a class="nav-link text-white px-3" href="/SAVELIFEnew/logout.php">تسجيل خروج</a>
            </li>
            <?php endif; ?>
        </ul>
    </div>
