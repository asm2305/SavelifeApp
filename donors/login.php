...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
   // Get the input data from the form
    ...
    if (!empty($full_name) && !empty($contact_number)) {
        ...
        $stmt = $conn->prepare("SELECT * FROM donors WHERE full_name = ? AND contact_number = ?");
        ...
        if ($result->num_rows > 0) {
            ...
            $_SESSION['contact_number'] = $donor['contact_number'];
...
<div class="container d-flex justify-content-center align-items-center" style="height: 60vh;">
    <div class="card">
        ...
        <div class="card-footer text-center">
            <a href="../donors/register.php">لا تمتلك حساب؟ سجل الآن</a>
        </div>
    </div>
</div>
